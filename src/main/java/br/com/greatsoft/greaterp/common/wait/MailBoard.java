package br.com.greatsoft.greaterp.common.wait;
...
public class MailBoard extends JPanel implements Runnable {
    ...
    private void loadImage() {
        ImageIcon ii = new ImageIcon(this.getClass().getResource("/br/com/greatsoft/greaterp/resource/image/mail-white.png"));
